    ...
    <div>
        <table align="center">
            <tr>
                ...
                <td>
                    <asp:Button ID="btnShow" runat="server" Text="查看" CssClass="btn" OnClick="btnShow_Click" />
                </td>
            </tr>
        </table>
        <hr />
        <asp:GridView ID="gvAttendShow" runat="server" AutoGenerateColumns="False" 
            CssClass="grid" onrowdatabound="gvAttendShow_RowDataBound">
            <Columns>
